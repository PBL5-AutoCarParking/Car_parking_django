...
urlpatterns = [
                  ...
                  path('api/cars/', login_required(user_passes_test(is_admin)(views.CarAPIList.as_view())),
                       name='api_car_list'),
                  ...
                  path('update_car/<int:pk>', user_passes_test(is_admin)(views.CarUpdateView.as_view()),
                       name='car_update'),
                  path('delete_car/<int:pk>', user_passes_test(is_admin)(views.CarDeleteView.as_view()),
                       name='car_delete'),
                  path('inactive_car/<int:pk>', user_passes_test(is_admin)(views.CarInactiveView.as_view()),
                       name='inactive_car'),
                  path('active_car/<int:pk>', user_passes_test(is_admin)(views.CarActiveView.as_view()),
                       name='active_car'),
                  ...
                  path('parking_record/create_parking_record',
                       user_passes_test(is_admin)(views.CreateParkingRecordView.as_view()),
                       name='create_parking_record'),
                  path('parking_record/update_parking_record/<int:pk>',
                       user_passes_test(is_admin)(views.ParkingRecordUpdateView.as_view()),
                       name='update_parking_record'),
                  path('parking_record/delete_parking_record/<int:pk>',
                       user_passes_test(is_admin)(views.ParkingRecordDeleteView.as_view()),
                       name='delete_parking_record'),
                  ...
                  path('active_user/<int:pk>', user_passes_test(is_admin)(views.UserActiveView.as_view()),
                       name='active_user'),
                  path('inactive_user/<int:pk>', user_passes_test(is_admin)(views.UserInactiveView.as_view()),
                       name='inactive_user'),
                  path('delete_user/<int:pk>', user_passes_test(is_admin)(views.UserDeleteView.as_view()),
                       name='delete_user'),
                  path('user_view/<int:pk>', user_passes_test(is_admin)(views.UserDetailView.as_view()),
                       name='user_view'),
                  ...
                  path('invoice/<int:pk>/', user_passes_test(is_admin)(views.InvoiceDetailView.as_view()),
                       name='invoice_detail'),
                  path('update_invoice/<int:pk>/', user_passes_test(is_admin)(views.InvoiceUpdateView.as_view()),
                       name='update_invoice'),
                  path('delete_invoice/<int:pk>/', user_passes_test(is_admin)(views.InvoiceDeleteView.as_view()),
                       name='delete_invoice'),
                  ...
                  path('customer_invoices/<int:pk>/', views.CustomerInvoiceDetail.as_view(),
                  ...
                  path('entry_car/', views.entry_car, name='entry_car'),
                  path('exit_car/', views.exit_car, name='exit_car'),
